...
# 数据集路径
dataset_dir = r'D:\python.learm\shixun\day3\images'  # 替换为你的数据集路径
train_dir = r'D:\python.learm\shixun\day3\train'  # 训练集输出路径
val_dir = r'D:\python.learm\shixun\day3\val'  # 验证集输出路径
